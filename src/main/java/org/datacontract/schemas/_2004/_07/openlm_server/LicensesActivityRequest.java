 ...
 *         &lt;element name="Products" type="{http://schemas.datacontract.org/2004/07/OpenLM.Server.VO}ArrayOfFeatureVendorServer" minOccurs="0"/>
    ...
    extends BaseRequest
{
    ...
    protected JAXBElement<ArrayOfFeatureVendorServer> products;
     ...
     *     
     */
    public JAXBElement<ArrayOfFeatureVendorServer> getProducts() {
        return products;
    }
     ...
     *     
     */
    public void setProducts(JAXBElement<ArrayOfFeatureVendorServer> value) {
        this.products = value;
    }
