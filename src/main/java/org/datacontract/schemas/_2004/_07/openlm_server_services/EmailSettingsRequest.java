 ...
 *         &lt;element name="NotificationRecipientAddress" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends BaseRequest
{
    ...
    @XmlElementRef(name = "NotificationRecipientAddress", namespace = "http://schemas.datacontract.org/2004/07/OpenLM.Server.Services.DataContracts", type = JAXBElement.class, required = false)
    protected JAXBElement<String> notificationRecipientAddress;
    ...
    /**
     * Gets the value of the notificationRecipientAddress property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getNotificationRecipientAddress() {
        return notificationRecipientAddress;
    }

    /**
     * Sets the value of the notificationRecipientAddress property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setNotificationRecipientAddress(JAXBElement<String> value) {
        this.notificationRecipientAddress = value;
    }
