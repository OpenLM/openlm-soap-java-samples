...
public class ObjectFactory {
    ...
    private final static QName _LicenseServerEnableStatus_QNAME = new QName("http://schemas.datacontract.org/2004/07/OpenLM.Shared.Public.Enums", "LicenseServerEnableStatus");
    private final static QName _CheckoutPolicy_QNAME = new QName("http://schemas.datacontract.org/2004/07/OpenLM.Shared.Public.Enums", "CheckoutPolicy");
    ...
    private final static QName _DenialType_QNAME = new QName("http://schemas.datacontract.org/2004/07/OpenLM.Shared.Public.Enums", "DenialType");
    private final static QName _CheckoutPolicySource_QNAME = new QName("http://schemas.datacontract.org/2004/07/OpenLM.Shared.Public.Enums", "CheckoutPolicySource");
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link LicenseServerEnableStatus }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/OpenLM.Shared.Public.Enums", name = "LicenseServerEnableStatus")
    public JAXBElement<LicenseServerEnableStatus> createLicenseServerEnableStatus(LicenseServerEnableStatus value) {
        return new JAXBElement<LicenseServerEnableStatus>(_LicenseServerEnableStatus_QNAME, LicenseServerEnableStatus.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/OpenLM.Shared.Public.Enums", name = "CheckoutPolicy")
    public JAXBElement<CheckoutPolicy> createCheckoutPolicy(CheckoutPolicy value) {
        return new JAXBElement<CheckoutPolicy>(_CheckoutPolicy_QNAME, CheckoutPolicy.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link DenialType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/OpenLM.Shared.Public.Enums", name = "DenialType")
    public JAXBElement<DenialType> createDenialType(DenialType value) {
        return new JAXBElement<DenialType>(_DenialType_QNAME, DenialType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/OpenLM.Shared.Public.Enums", name = "CheckoutPolicySource")
    public JAXBElement<CheckoutPolicySource> createCheckoutPolicySource(CheckoutPolicySource value) {
        return new JAXBElement<CheckoutPolicySource>(_CheckoutPolicySource_QNAME, CheckoutPolicySource.class, null, value);
    }
