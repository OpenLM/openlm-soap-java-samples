...
public class ObjectFactory {
    ...
    private final static QName _EffectiveLicenseFeatureValue_QNAME = new QName("http://schemas.datacontract.org/2004/07/OpenLM.LicenseManager.Shared.Domain", "Value");
    private final static QName _EffectiveLicenseFeatureVendorName_QNAME = new QName("http://schemas.datacontract.org/2004/07/OpenLM.LicenseManager.Shared.Domain", "VendorName");
    ...
    public JAXBElement<String> createEffectiveLicenseFeatureValue(String value) {
        return new JAXBElement<String>(_EffectiveLicenseFeatureValue_QNAME, String.class, EffectiveLicenseFeature.class, value);
    }
    ...
    public JAXBElement<String> createEffectiveLicenseFeatureVendorName(String value) {
        return new JAXBElement<String>(_EffectiveLicenseFeatureVendorName_QNAME, String.class, EffectiveLicenseFeature.class, value);
    }
    ...
    public JAXBElement<String> createBaseLicenseClassValue(String value) {
        return new JAXBElement<String>(_EffectiveLicenseFeatureValue_QNAME, String.class, BaseLicenseClass.class, value);
    }
    ...
    public JAXBElement<String> createBaseLicenseClassVendorName(String value) {
        return new JAXBElement<String>(_EffectiveLicenseFeatureVendorName_QNAME, String.class, BaseLicenseClass.class, value);
    }
