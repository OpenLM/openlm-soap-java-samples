...
import org.datacontract.schemas._2004._07.openlm_shared_public.LicenseServerEnableStatus;
 ...
 *       &lt;sequence>
 *         &lt;element name="ConfigurationIsDirty" type="{http://schemas.microsoft.com/2003/10/Serialization/}char" minOccurs="0"/>
 *         &lt;element name="EnableStatus" type="{http://schemas.datacontract.org/2004/07/OpenLM.Shared.Public.Enums}LicenseServerEnableStatus" minOccurs="0"/>
 *         &lt;element name="HasLicenseFile" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
...
public class LicenseServerStatistics {
    ...
    @XmlElement(name = "ConfigurationIsDirty")
    protected Integer configurationIsDirty;
    @XmlElement(name = "EnableStatus")
    @XmlSchemaType(name = "string")
    protected LicenseServerEnableStatus enableStatus;
    @XmlElement(name = "HasLicenseFile")
    protected Boolean hasLicenseFile;
    ...
    @XmlElementRef(name = "TimeZone", namespace = "http://schemas.datacontract.org/2004/07/OpenLM.Server.VO", type = JAXBElement.class, required = false)
    ...
    /**
     * Gets the value of the configurationIsDirty property.
     * 
     * @return
     *     possible object is
     *     {@link Integer }
     *     
     */
    public Integer getConfigurationIsDirty() {
        return configurationIsDirty;
    }

    /**
     * Sets the value of the configurationIsDirty property.
     * 
     * @param value
     *     allowed object is
     *     {@link Integer }
     *     
     */
    public void setConfigurationIsDirty(Integer value) {
        this.configurationIsDirty = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link LicenseServerEnableStatus }
     *     
     */
    public LicenseServerEnableStatus getEnableStatus() {
        return enableStatus;
    }
     ...
     *     
     */
    public void setEnableStatus(LicenseServerEnableStatus value) {
        this.enableStatus = value;
    }

    /**
     * Gets the value of the hasLicenseFile property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the hasLicenseFile property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setHasLicenseFile(Boolean value) {
        this.hasLicenseFile = value;
    }
