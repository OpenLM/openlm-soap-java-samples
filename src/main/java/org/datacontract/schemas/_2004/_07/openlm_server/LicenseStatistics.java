 ...
 *         &lt;element name="CheckoutPolicySource" type="{http://schemas.datacontract.org/2004/07/OpenLM.Shared.Public.Enums}CheckoutPolicySource" minOccurs="0"/>
...
public class LicenseStatistics {
    ...
    @XmlElementRef(name = "CheckoutPolicy", namespace = "http://schemas.datacontract.org/2004/07/OpenLM.Server.VO", type = JAXBElement.class, required = false)
    protected JAXBElement<CheckoutPolicy> checkoutPolicy;
    @XmlElementRef(name = "CheckoutPolicySource", namespace = "http://schemas.datacontract.org/2004/07/OpenLM.Server.VO", type = JAXBElement.class, required = false)
    protected JAXBElement<CheckoutPolicySource> checkoutPolicySource;
    ...
    /**
     * Gets the value of the checkoutPolicySource property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CheckoutPolicySource }{@code >}
     *     
     */
    public JAXBElement<CheckoutPolicySource> getCheckoutPolicySource() {
        return checkoutPolicySource;
    }

    /**
     * Sets the value of the checkoutPolicySource property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link CheckoutPolicySource }{@code >}
     *     
     */
    public void setCheckoutPolicySource(JAXBElement<CheckoutPolicySource> value) {
        this.checkoutPolicySource = value;
    }
